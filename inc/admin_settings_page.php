    ...
    <table class="form-table">
      <tr>
				...
				<td>
					...
					<code>/</code>
					<a href="<?php echo get_site_url()?>/<?php echo lottery_page_slug();  ?>" class="button mcwallet-button-url<?php if( get_option( 'lotteryfactory_is_home' ) ) { echo ' disabled';}?>" target="_blank">
...
function lotteryfactory_update_pageoptions() {
  ...
  if ( untrailingslashit( $_POST['slug'] ) ) {
    ...
    update_option( 'lotteryfactory_slug', $slug );
  }
