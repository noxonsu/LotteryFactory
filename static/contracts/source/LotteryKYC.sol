 ...
 */
contract PancakeSwapLotteryKYC is ReentrancyGuard, IPancakeSwapLottery, Ownable {
    ...
    function setKYCToken(address _KYCTokenAddress) public onlyOwner {
     ...
     */
    constructor(address _cakeTokenAddress, bool _OnoutFeeEnabled, address _KycToken, bool _KycEnabled) {
        cakeToken = IERC20(_cakeTokenAddress);
        KYCToken = IKYCToken(_KycToken);
        KYCEnabled = _KycEnabled;
