      ...
      return (
        <>
          <div className="tab-menu-items">
            ...
            <div className={styles.adminForm}>
              ...
              <div className={styles.actionsRow}>
                <button className={styles.adminButton} onClick={openAddMenu}>
                  <FaIcon icon="add" />
                  Add new menu item
                </button>
              </div>
            ...
            <AdminPopupWindow title={(isEditAction) ? `Edit menu item` : `Add new menu item`} isOpened={isEditAddOpened}>
              <div className={styles.adminForm}>
                <div className={styles.subFormInfo}>
                  ...
                  <div className={styles.actionsRow}>
                    <button className={styles.adminButton} onClick={onAddEditDo}>{isEditAction ? `Edit` : `Add`}</button>
                    <button className={styles.adminButton} onClick={onCancelAddEdit}>Cancel</button>
                  </div>
                </div>
              </div>
            </AdminPopupWindow>
          ...
          <div className={styles.actionsRowMain}>
            <SwitchNetworkAndCall chainId={`STORAGE`} icon="save" className={styles.adminMainButton} disabled={isSaveMenus} onClick={doSaveMenus}  action={`Save changes`} >
              {isSaveMenus ? `Saving...` : `Save to storage config`}
